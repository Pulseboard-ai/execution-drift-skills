...
## 0.1.0 — 2026-08
- `reconcile-status`: 8-link Done Chain, three input modes, sample program, 5 evals
- `resolve-blocker`: 7-type blocker taxonomy, escalation gate, precedent log, decision memo, memo lint (leader mode)
