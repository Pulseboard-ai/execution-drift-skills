...
Legend: ✔ confirmed · ✖ conflicting · ? unverified · manual = human check required
...
- Evidence: PAY-144 QA task In Progress; PR #88 draft since 2026-08-11; no deploy evidence; PAY-151 Sev-2 open; notifications-team never notified (billing-team was, 08-10)
- What the reporter probably saw: epic flipped to Done when subtasks closed; PR and defect not reflected
- What would close it: finish PAY-144, merge #88, deploy, close PAY-151, post to #notifications-team
